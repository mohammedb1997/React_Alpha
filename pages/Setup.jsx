  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden px-4 py-8">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-team-a/8 rounded-full blur-[130px]" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-team-b/8 rounded-full blur-[130px]" />
      </div>
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-black text-primary">إعداد اللعبة</h2>
          <p className="text-xs text-muted-foreground mt-1">اختر أسماء الفرق وعدد الجولات</p>
        </div>
        ...
        {/* Timer Duration */}
        <div className="mb-4">
          <label className="block text-xs font-bold text-primary mb-1.5">⏱️ مدة المؤقت للسؤال</label>
        ...
        <div className="bg-secondary/60 rounded-xl p-4 mb-6 border border-border">
          <p className="text-xs text-muted-foreground text-center leading-relaxed">
            <span className="text-team-a font-bold">🟠 {teamA || 'الفريق الأحمر'}</span>
            {' '}يصل يمين ← يسار
            <br />
            <span className="text-team-b font-bold">🟢 {teamB || 'الفريق الأخضر'}</span>
            {' '}يصل أعلى ← أسفل
          </p>
        </div>
